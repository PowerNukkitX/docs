...
<Cards>
    <Card icon={<CpuIcon className="text-primary" />} title="Install PowerNukkitX" href="/docs/guides/installation">
    ...
    <Card icon={<SettingsIcon className="text-primary" />} title="Configure your server" href="/docs/guides/configuration">
    ...
    <Card icon={<PuzzleIcon className="text-primary" />} title="Develop plugins" href="/docs/guides/plugin-development">
    ...
    <Card icon={<ShieldIcon className="text-primary" />} title="Permissions & security" href="/docs/(software)/permissions">
