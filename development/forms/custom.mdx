...
description: "The CustomForm is a modal form inside Minecraft featuring adjustable elements. Follow the steps below to find out how to use this form inside PNX.
              It consists of a title and multiple elements."
authors:
