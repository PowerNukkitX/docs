...
title: ModalForm
icon: MessageSquare
description: "The ModalForm is a modal form inside Minecraft featuring two clickable buttons commonly used for decision-making. Follow the steps below to find out how to use this form inside PNX.
              It consists of a title, content & two buttons (yes and no)"
authors:
    - PleaseInsertNameHere
---
