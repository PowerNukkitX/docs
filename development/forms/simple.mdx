---
title: SimpleForm
description: "The SimpleForm is a modal form inside Minecraft featuring clickable buttons. Follow the steps below to find out how to use this form inside PNX.
             It consists of a title, content and buttons."
authors:
